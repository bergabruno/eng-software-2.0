...
export default function StatusDataprev({ simulacao, onVoltar, onContinuar }) {
  const [status, setStatus] = useState('loading') // 'loading' | 'sucesso' | 'erro'
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        <div className="max-w-md w-full">
          ...
          {status === 'sucesso' && (
            <div className="card flex flex-col gap-6">
              <div className="flex flex-col items-center gap-3 text-center">
                <span className="badge-success text-base px-4 py-2">✓ Aprovado pela Dataprev</span>
          ...
          {status === 'erro' && dados && (
            <div className="card flex flex-col gap-6">
              <div className="flex flex-col items-center gap-3 text-center">
                <span className="badge-error text-base px-4 py-2">✗ Reprovado pela Dataprev</span>
